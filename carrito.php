<?php
	...
	if(isset($post['nombre']))
	{
		...
		$lst_carrito = Sql_select('carrito',array('sesion' => $_SESSION['sesion_carrito']),'=');
		foreach($lst_carrito as $item)
		{
			...
			$sub_de = $item['sub'] == '' ? '' : ' - '.$item['sub'];
			
			$msj .= '<tr>';
			$msj .= 	'<td>';
			$msj .= 		$producto['codigo'].$sub_de;
			$msj .= 	'</td>';
			$msj .= 	'<td>';
			$msj .= 		$producto['nombre'];
			$msj .= 	'</td>';
		...
		Sql_delete('carrito',array('sesion' => $_SESSION['sesion_carrito']));
		
		header("location: exito_carrito/");
		exit;
	}
						...
						<?php if(is_array($lst_carrito)){ ?>
							...
							?>
								<tr>
									...
									<td><?php echo $producto['codigo'].$sub_de; ?></td>
